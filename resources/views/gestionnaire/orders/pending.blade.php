...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="page-header">
            <h1 class="h3 mb-0 text-gray-800">Commandes en attente</h1>
        </div>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-primary">Filtrer les commandes en attente</h6>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8 mb-3">
                        <form class="d-flex gap-2" action="{{ route('gestion.orders.pending') }}" method="GET">
                            ...
                            <a href="{{ route('gestion.orders.pending') }}" class="btn btn-outline-secondary">Réinitialiser</a>
                        </form>
                    </div>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-primary">Liste des commandes en attente</h6>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        @forelse($orders as $order)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('gestion.orders.updateStatut', $order->id) }}" method="POST" class="d-flex gap-2">
                                        @csrf
                                        @method('POST')
                                ...
                                <td class="text-center">
                                    <div class="action-buttons">
                                        ...
                                        <form action="{{ route('gestion.orders.cancel', $order->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Êtes-vous sûr de vouloir annuler cette commande?')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-sm btn-delete action-btn">
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center">Aucune commande en attente trouvée</td>
                            </tr>
                        @endforelse
                        </tbody>
                    </table>
