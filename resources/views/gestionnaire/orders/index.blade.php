    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-primary">Filtrer les commandes</h6>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8 mb-3">
                        <form class="d-flex gap-2" action="{{ route('gestion.orders.index') }}" method="GET">
                            ...
                            <a href="{{ route('gestion.orders.index') }}" class="btn btn-outline-secondary">Réinitialiser</a>
                        </form>
                    </div>
